...
/**
 * What the report above could not count, in words (audit A11, A31). Renders
 * nothing when there is nothing to say — a warning that is always there is
 * one nobody reads.
 */
export async function PnlGapsNote({ gaps }: { gaps: PnlGaps }) {
  if (gaps.manualCharges.count === 0 && gaps.unconverted.count === 0) return null;
