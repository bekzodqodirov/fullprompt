 ...
 *
 * The CALCULATION is the main column and the seller's materials are the rail,
 * which is the right order for both shapes at once: on a desktop the working
 * surface takes the width, and on a phone the rail renders first, so the VED
 * reads what was sent before scrolling into the table.
 *
 ...
 * screen down instead of the half that is new (#472-475).
 */
