...
/**
 * The two phone settings that decide whether the sync survives the week.
 *
 ...
 * all. Both are the usual reason a background app goes quiet on day two, so
 * the setup screen walks the person through them.
 */
object Setup {
